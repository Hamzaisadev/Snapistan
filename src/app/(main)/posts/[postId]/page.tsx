...
import UserTooltip from "@/components/UserToolotip";
...
async function UserInfoSidebar({ user }: UserInfoSidebarProps) {
  ...
  return (
    <div className="space-y-5 rounded-2xl bg-card p-5 shadow-sm">
      <div className="text-x1 font-bold">About this user</div>
      <UserTooltip user={user}>
        ...
        >
          ...
          <div>
            <p className="line-clamp break-all font-semibold hover:underline">
              {user.displayName}
            </p>
